...
<body  style="background-image: url(images/background/back2.png)">
 ...
 %>
 <h1 style="position:absolute;left: 42%">收件箱界面</h1>

 <table border="1" style="position:absolute;left: 15%;top: 20%;table-layout:fixed;width: 1000px">
    <tr>
        <td>ID</td><td>发送邮箱</td><td>收件邮箱</td><td>主题</td><td>正文</td><td>附件</td><td>查看详情</td><td>操作</td>
    </tr>
    <%
    ...
    <tr>
        ...
        <td><a href="emaildetail1?id=<%= email.getId() %>">详情</a></td>
    ...
    <div style="position:absolute;left: 30%;top: 67%;">
        ...
        <a href="findEmailPageable2?pageNow=<%=  p.getPageNow() - 1 %>">上一页</a>
        <a href="findEmailPageable2?pageNow=<%=  p.getPageNow() + 1 %>">下一页</a>
    <div>
